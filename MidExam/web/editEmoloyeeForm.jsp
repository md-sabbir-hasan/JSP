    ...
    <form action="editEmployee.jsp"  method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="email" name="email" value="<%=e.getEmail()%>" placeholder=" ">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="desig" name="desig" value="<%=e.getDesig()%>" placeholder=" ">
            </div>
